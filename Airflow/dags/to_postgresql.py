...
with DAG(
    ...
    task2 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_temperature FROM '/Users/Bowen/Downloads/Final_Project/data/output/transformation-temperature-LasVegas' DELIMITER ',' CSV HEADER;
    ...
    task4 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_precipitation FROM '/Users/Bowen/Downloads/Final_Project/data/output/transformation-precipitation-LasVegas.csv' DELIMITER ',' CSV HEADER;
    ...
    task6 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_business FROM '/Users/Bowen/Downloads/Final_Project/data/output/business_restaurant.csv' DELIMITER ',' CSV HEADER;
    ...
    task8 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_user1 FROM '/Users/Bowen/Downloads/Final_Project/data/output/user_restaurant.csv' DELIMITER ',' CSV HEADER;
    ...
    task10 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_checkin FROM '/Users/Bowen/Downloads/Final_Project/data/output/checkin_restaurant1.csv' DELIMITER ',' CSV HEADER;
    ...
    task12 = PostgresOperator(
        ...
        sql="""
            ...
            COPY dim_temp_tip FROM '/Users/Bowen/Downloads/Final_Project/data/output/tip_restaurant.csv' DELIMITER ',' CSV HEADER NULL 'NA';
    ...
    task14 = PostgresOperator(
        ...
        sql="""
            ...
            COPY fact_temp_review FROM '/Users/Bowen/Downloads/Final_Project/data/output/review_restaurant.csv' DELIMITER ',' CSV HEADER NULL 'NA';
